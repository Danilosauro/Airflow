...
dag = DAG('banco_de_dados', description='BANCO DE DADOS CURSO AIRFLOW', 
...
print_resul_task = PythonOperator(task_id='print_result_task', 
                                python_callable=print_result, 
                                provide_context=True, 
                                dag=dag) 


create_table >> insert_data >> query_data >> print_resul_task